// ─────────────────────────────────────────────────────────────────────────────
// Активная страница тарифов — это v2. Маршрут /plans теперь рендерит ту же
// страницу, что и /plans/v2 (через ре-экспорт), чтобы не дублировать код.
// Дизайн и логика — как в v2.
//
// Старая версия страницы скрыта (закомментирована построчно) ниже,
// чтобы при необходимости её можно было быстро восстановить.
// ─────────────────────────────────────────────────────────────────────────────

export { default } from './v2/page';

// ─────────────────────────── OLD VERSION (hidden, не удалять) ────────────────
// 'use client';
// 
