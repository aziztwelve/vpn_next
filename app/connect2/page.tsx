...
const HAPP_APPSTORE_RU = 'https://apps.apple.com/ru/app/happ-proxy-utility/id6504287215';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 pb-24">
      <div className="max-w-2xl mx-auto px-4 pt-4 space-y-4">
        ...
        {/* ─── Блок «Твой ключ» — QR + ссылка подписки ─────────────────
            Отдельный блок внизу страницы. Перенесён из /connect: тот же
            subscription_url, но в стиле /connect2 (slate-700/50 + cyan).  */}
